...
//
// Netools makes it possible to accept incoming network connections with certain
...
var (
	build    = "Custom"
	codename = "Netools, Penetrates Everything."
...
func VersionStatement() []string {
	return []string{
		serial.Concat("Netools ", Version(), " (", codename, ") ", build, " (", runtime.Version(), " ", runtime.GOOS, "/", runtime.GOARCH, ")"),
		intro,
	}
}
