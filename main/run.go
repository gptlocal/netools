...
var cmdRun = &base.Command{
	...
	Short:     "Run Netools with config, the default command",
	Long: `
Run Netools with config, the default command.

The -config=file, -c=file flags set the config files for 
Netools. Multiple assign is accepted.
...
The -test flag tells Netools to test config files only, 
...
var (
	...
	configDir   string
	test        = cmdRun.Flag.Bool("test", false, "Test config file only, without launching Netools server.")
	 ...
	 */
	_ = func() bool {
		cmdRun.Flag.Var(&configFiles, "config", "Config path for Netools.")
