...
// A Command is an implementation of a netools command
// like netools run or netools version.
type Command struct {
...
// LongName returns the command's long name: all the words in the usage line between first word (e.g. "netools") and a flag or argument,
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stderr, "Run 'netools help %s' for details.\n", c.LongName())
	SetExitStatus(2)
	Exit()
}
